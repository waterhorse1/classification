...
def parse_args():
    ...
    parser.add_argument('--data_path', type=list, default=['./meta-dataset/CUB_Bird/','./meta-dataset/FGVCx_Fungi/','./meta-dataset/FGVC_Aircraft/','./meta-dataset/DTD_Texture/'], help='folder which contains image data')
